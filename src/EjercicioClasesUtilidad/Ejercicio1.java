 ...
 * El constructor con frase como atributo debe setear la longitud de la frase de manera automática. Crear
...
public class Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        Cadena frase = new Cadena(leer.nextLine());
        cs.mostrarVocales(frase);
        cs.invertirFrase(frase);
        System.out.println("Ingrese una letra qu quiere ver cuantas veces se repite en le texto");
        cs.vecesRepetido(frase, leer.next());
        System.out.println("Ingrese una Segunda Frase para compararla con la primera:");
        cs.compararLongitud(frase, leer.next());
        cs.unirFrase(frase);
        System.out.println("Ingrese la Nueva letra por la que quiere reemplazar la 'a' en el texto");
        cs.reemplazar(frase, leer.next());
        System.out.println("Ingrese letra a buscar dentro de la frase");
        cs.contiene(frase, leer.next());
