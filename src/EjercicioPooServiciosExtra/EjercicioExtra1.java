...
package EjercicioPooServiciosExtra;
...
public class EjercicioExtra1 {
     ...
     * calcular la letra se toma el resto de dividir el número de DNI por 23 (el resultado debe ser un número entre 0 y 22). El
     * método debe buscar en un array (vector) de caracteres la posición que corresponda al resto de la división para obtener la
